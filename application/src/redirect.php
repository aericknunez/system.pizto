...
elseif(isset($_GET["diariol"])) include_once 'system/historial/listavendidos.php';
...
elseif(isset($_GET["resumen_meseros"])) include_once 'system/historial/resumen_meseros.php';
