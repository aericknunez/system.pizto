...
?>
  ...
  <div class="row justify-content-md-center">
    <div class="col-12 col-md-auto">
        <form name="form-meseros" method="post" id="form-meseros">
  ...
  <div class="row justify-content-md-center">
    ...
    <button class="btn btn-info my-2 btn-rounded btn-sm waves-effect" type="submit" id="btn-meseros" name="btn-meseros">Mostra Datos</button>
      </form> 
    </div>
  </div>
