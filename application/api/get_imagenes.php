...
$check =  file_get_contents("https://app.hibridosv.com/api/imagenes_checker.php"); 
...
$data =  file_get_contents("https://app.hibridosv.com/api/imagenes.php"); 
...
$data =  file_get_contents("https://app.hibridosv.com/api/categorias_imagenes.php"); 
$datos = json_decode($data, true);
