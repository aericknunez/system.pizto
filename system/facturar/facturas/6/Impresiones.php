...
class Impresiones{
 ...
 public function Ticket($efectivo, $numero){
  ...
  $img  = "C:/AppServ/www/pizto/assets/img/logo_factura/italia.jpg";
...
$printer->text("Antiguo local de Wester Union salida a Tegucigalpa. Choluteca");

$printer->feed();
$printer->text("Tel: 2782-6000");
